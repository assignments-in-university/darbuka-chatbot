...
<template>
  <div class="flex w-full">
    ...
    <motion.main class="ml-auto w-full md:w-[calc(100%-288px)] duration-300">
      ...
      <div
        class="text-white bg-neutral-950 min-h-[calc(100vh-64px)] p-4 relative bg-[repeating-radial-gradient(var(--color-neutral-900)_0,var(--color-neutral-900)_1px,transparent_1px,transparent_100%)] bg-size-[20px_20px] mt-16 overflow-hidden"
      >
